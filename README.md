...
| [RateMyOpenAPI](https://ratemyopenapi.com/) | Open-source tool that scans your OpenAPI spec for security, documentation, and SDK generation issues - and generates a report with action items and suggestions. |
